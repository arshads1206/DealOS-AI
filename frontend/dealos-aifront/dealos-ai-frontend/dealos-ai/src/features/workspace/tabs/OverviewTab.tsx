          ...
          <GlassCard className="p-6" raised>
            ...
            <ResponsiveContainer width="100%" height={200}>
              <AreaChart data={company.history} margin={{ top: 4, right: 4, left: -24, bottom: 0 }}>
                ...
                />
                <Area type="monotone" dataKey="revenue" stroke="#D4B34A" strokeWidth={2} fill="url(#rev-fill)" />
                <Area type="monotone" dataKey="ebitda" stroke="#5B9BD5" strokeWidth={2} fill="url(#ebitda-fill)" />
              </AreaChart>
            </ResponsiveContainer>
          </GlassCard>
        </Reveal>
