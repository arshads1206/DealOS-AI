...
const tones: Record<Tone, string> = {
  gold: "bg-[var(--color-gold-500)]/[0.12] text-[var(--color-gold-300)] border-[var(--color-gold-500)]/30",
  emerald: "bg-[var(--color-emerald)]/[0.12] text-[var(--color-emerald)] border-[var(--color-emerald)]/30",
  amber: "bg-[var(--color-amber)]/[0.12] text-[var(--color-amber)] border-[var(--color-amber)]/30",
  crimson: "bg-[var(--color-crimson)]/[0.12] text-[var(--color-crimson)] border-[var(--color-crimson)]/30",
  ice: "bg-[var(--color-ice)]/[0.12] text-[var(--color-ice)] border-[var(--color-ice)]/30",
