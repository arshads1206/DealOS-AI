...
export function CompanyWorkspacePage() {
  ...
  return (
    <div className="pb-16">
      ...
      <div className="ledger-rule-glow mx-8 mt-6" />

      <div className="sticky top-0 z-10 mt-3 bg-[var(--color-bg)]/85 backdrop-blur-xl px-8">
...
function Metric({ label, value, tone }: { label: string; value: string; tone?: "emerald" }) {
  return (
    <div>
      <p className={cn("figure-display text-[17px] font-medium", tone === "emerald" ? "text-[var(--color-emerald)]" : "text-[var(--color-ink-0)]")}>{value}</p>
